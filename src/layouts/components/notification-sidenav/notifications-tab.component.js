    ...
    return (
      <div className={scss["portal-notifications-wrapper"]}>
        ...
        {this.state.notifications
          .filter(notification =>
            notification.date.isBetween(moment().subtract(1, "day"), moment())
          )
          .map(notification => (
            <Card
              className={scss["portal-notifications-card"]}
              key={notification.id}
            >
              <CardHeader
                ...
                classes={{
                  ...
                  avatar: classNames([
                    ...
                    classes[notification.iconClass]
                  ])
                }}
